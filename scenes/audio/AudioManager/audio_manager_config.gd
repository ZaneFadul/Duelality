...
onready var handle_error
onready var output_message
var tracks = {}
var audio_actions = {}
var state_directory = {}
var trees = {}
...
func _handle_config():
	...
	if err == OK:
		output_message.call_func('Configuration file loaded and parsed successfully!')
		...
		handle_error.call_func('Configuration failed. Does audio.ini have syntax errors?')
